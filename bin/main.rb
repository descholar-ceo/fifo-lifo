...
class Main
    def initialize(bitcoins, prices)
        ...
        @fifo = Fifo.new(@utils) # initializing the fifo object
        @lifo = Lifo.new(@utils) # initializing the lifo object
    end
    ...
    def display_results
        ...
        puts "\n\n"
        puts "=======  The Results that you are about to see, are for the following inputs  ======="
        puts "============================================================================================"
        puts "The list of items is: #{@utils.bitcoins}. Note: All negative values indicate sellings, whereas positive values indicate purchasings"
        puts "The list of amounts is: #{@utils.prices}"
        puts "To change the values, you can edit the bin/main.rb file on the instatiation of the Main class!!!"
